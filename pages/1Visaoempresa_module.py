...
with tab3:
    ...
    df55.groupby(['City', 'Road_traffic_density' ]).median().reset_index()
    df55= df55[df55['City'] !='NaN'] 
    df55=df55[df55['Road_traffic_density'] !='NaN'] 
    

    # Dados de exemplo
    dados = {
        'Delivery_location_latitude': [-23.5505], 
        'Delivery_location_longitude': [-46.6333]
    }
    df55 = pd.DataFrame(dados)
